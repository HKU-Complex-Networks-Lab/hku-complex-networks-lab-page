    ...
    return (
        <section>
            <h1 className="mb-8 text-2xl font-semibold tracking-tighter">
                HKU Complex Networks Laboratory
            </h1>
            <p className="mb-8">
                The Complex Networks Lab at the University of Hong Kong investigates the structure, dynamics, and functions of complex systems through the lens of network science. Our interdisciplinary research spans theoretical foundations of network science to applications in transportation, social systems, and biological networks.
            </p>
            ...
            <ResearchArea 
                ...
                image="/images/network-theory.png"
                papers={[
                    {
